    ...
    if (!showPromotionBar) {
        ...
        return (
            <div className='promote-bar bg-black'>
                <div className='container flex text-white justify-between relative px-4'>
                    ...
                    <i className='bx bx-x text-xl hover:cursor-pointer my-auto absolute md:right-0 right-4 top-[5px]' onClick={closePromotionBar}></i>
                </div>
            </div>
        )
    }
