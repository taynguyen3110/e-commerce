...
export const ItemCard = () => {
    return (
        <div className='flex flex-col gap-[6px] md:w-[295px] w-5/12 mx-2 md:mb-0 mb-5'>
            ...
            <div>
                <p className='md:text-xl text-base font-bold'>T-shirt with Tape Details</p>
            </div>
            <div>
                <img className='inline-block mr-3' src={nineRate} alt="" />
                <span className='md:text-sm text-xs'>4.5/5</span>
            </div>
            <div>
                <div className='flex items-center gap-[10px] md:text-2xl text-xl font-bold'>
                    <div>$240</div>
                    <div className='opacity-40 line-through'>$260</div>
                    <div className='md:text-xs text-[10px] flex items-center md:px-[14px] md:py-[6px] px-1 h-5 text-[#FF3333] bg-opacity-10 bg-[#FF3333] rounded-2xl'>-20%</div>
                </div>
            </div>
        </div>
    )
