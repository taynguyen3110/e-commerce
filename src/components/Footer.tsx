        ...
        <div className="bg-black rounded-3xl">
          <div className="flex md:py-10 md:px-20 px-6 py-8 md:flex-row md:gap-0 gap-7 flex-col">
            <div className="flex items-center">
              <h1 className="lg:text-5xl text-3xl text-white md:w-3/4">
            ...
            <div className="flex items-center md:w-1/3">
              <form className="w-full">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="md:py-4 py-3 pl-[50px] min-w-60 w-full rounded-full placeholder:text-left placeholder:text-sm md:placeholder:text-base"
                    placeholder="Enter your email address"
                  ></input>
                </div>
                <Button
                  purpose="secondary"
                  className="mt-[14px] min-w-60 w-full"
                >
          ...
          <div className="flex md:justify-between md:flex-nowrap md:text-base text-sm items-center flex-wrap md:mb-9 mb-2">
            <div className="md:max-w-[250px] flex flex-col md:gap-3 gap-2 md:mb-0 mb-6">
              <div className="nav-logo relative">
                <p className="relative md:text-4xl text-3xl -top-1">
                  <a href="/">Shop.co</a>
                </p>
              </div>
              <p>
