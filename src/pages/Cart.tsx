          ...
          <div className="lg:w-7/12 border rounded-2xl p-3 pb-0 flex flex-col gap-3">
            {cartItems && cartItems.length > 0 ? (
              cartItems.map((i, index) => {
                ...
                if (product) {
                  return (
                    <CartItemComp key={index} product={product} cartItem={i} />
                  );
                }
              })
            ) : (
          ...
          <div className="lg:w-5/12 mt-3 lg:mt-0 p-4 border rounded-2xl">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex w-full gap-4">
                ...
                <button className="bg-black text-white rounded-full w-1/3 text-sm">
                  Apply
                </button>
              </div>
              <button
                className="bg-black text-white rounded-full w-full text-sm py-4"
                onClick={() => {
