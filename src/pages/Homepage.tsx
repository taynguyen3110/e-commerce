      ...
      <div className=' bg-[#F2F0F1]'>
        <div className='container md:h-[663px] md:flex-row md:px-0 px-4 flex flex-col justify-between min-[414px]:gap-12 gap-5 overflow-hidden'>
          ...
          <div className='md:w-1/2 lg:overflow-hidden overflow-y-clip md:h-auto h-[400px] relative'>
            <img src={starIcon} className="absolute md:hidden lg:scale-50 md:top-[50%] md:translate-y-[-50%] md:left-0 -left-5 scale-[40%] top-20 z-10" alt="" />
            <img src={starIcon} className="absolute md:hidden md:right-0 md:top-20 lg:scale-100 -right-3 scale-[65%] z-10" alt="" />
            <img className='md:object-fit lg:scale-[0.89] lg:translate-x-11 lg:translate-y-[-6.7rem] md:top-20 md:block relative  min-[414px]:top-7 top-3 scale-125 z-0' src={heroImg} alt="" />
          </div>
        </div>
      </div>
