      ...
      <div className="container px-4 md:px-0">
          ...
          <div className="lg:flex lg:gap-8 lg:h-auto mb-10 lg:mb-14">
            <div className="flex flex-col lg:flex-row lg:w-1/2 gap-3 mb-5 lg:mb-0">
              ...
              <div className="flex gap-3 lg:w-[calc(24.6%-6px)] lg:flex-col">
                {colorInput
                  ? product.imgSource[colorInput].map((src, index) => {
                      return (
                        <div
                          key={index}
                          className={classNames(
                            "w-[calc(33.33%-8px)] lg:w-full lg:rounded-2xl flex items-center justify-center cursor-pointer rounded-3xl border",
                            { "border-black": currentImg === src }
                          )}
                        >
                          <img
                            className="rounded-3xl lg:rounded-2xl"
                            onClick={() => setCurrentImg(src)}
                            onMouseEnter={() => setCurrentImg(src)}
                            src={src}
                            alt=""
                          />
                        </div>
              ...
              <div className="lg:block lg:w-[calc(75.4%-6px)] hidden">
                {product.imgSource && (
                  <img
                    className="rounded-3xl lg:rounded-2xl md:w-full"
                    src={currentImg}
                    alt=""
                  />
                )}
            ...
            <div className="lg:w-1/2 lg:flex lg:flex-col lg:justify-between lg:">
              <div className="flex flex-col gap-2 lg:gap-0">
                ...
                <div>
                  <div className="flex items-center gap-[10px] lg:text-2xl text-2xl font-bold">
                    ...
                    {product.sale !== 0 ? (
                      <>
                        <div className="opacity-40 text-2xl line-through">
                          {product.price}
                        </div>
                        <div className="lg:text-xs text-sm flex items-center font-normal md:px-[14px] md:py-[6px] px-2 py-3 h-5 text-[#FF3333] bg-opacity-10 bg-[#FF3333] rounded-full">
                          -{product.sale}%
                        </div>
                      </>
                    ) : null}
                ...
                <div className="mt-2">
                  <p className="text-sm lg:text-base lg:h-[69px] lg:text-wrap lg:truncate">
                    {product.description}
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex">
                  <div className="flex flex-wrap gap-4 mt-2">
                    {Object.entries(productColors).map(
                      ([key, value], index) => {
                        return (
                          <button
                            className={classNames(
                              "p-5 rounded-full border hover:border-black",
                              {
                                "opacity-20 hover:border-white":
                                  stockOutByColor(key),
                              }
                            )}
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <button
                    className={classNames(
                      "px-5 py-2 bg-background rounded-full",
                      { "opacity-30": stockOutBySize("S") }
                    )}
                    onClick={() => {
                      setSizeInput("S");
                    }}
        ...
        <div className="lg:h-[910px] md:h-[790px] h-[790px]">
          <div className="flex justify-around mb-5 border-b-2">
            <p
              className={classNames("pb-3 lg:w-1/3 text-center", {
                "border-b-black border-b-[1px] opacity-100":
                  selectedTab === "detail",
              })}
              onClick={() => {
          ...
          {selectedTab === "detail" && product ? (
            <motion.div
              style={{ x: -50 }}
              animate={{ x: 0 }}
              className="flex flex-col gap-2 lg:gap-3 pt-2 lg:text-lg lg:pt-10"
            >
              <p>
              ...
              <p>
                <span className="font-bold">Sizes Available: </span>Small (S),
                Medium (M), Large (L)
              </p>
              <p>
                <span className="font-bold">Colors Available: </span>
                {productColors
                  ? Object.entries(productColors).map(([key, value], index) => (
                      <span key={index}>{formatTitle(key)} </span>
                    ))
                  : null}
              </p>
              <p>
              ...
              <p>
                <span className="font-bold">Brand: </span>Shop.Co
              </p>
              <p>
                <span className="font-bold">Material: </span>100% Organic Cotton
              </p>
              <p>
              ...
              <ol className="list-disc pl-10">
                <li>
                  <p>
                    <span className="font-bold">Classic Fit: </span>Designed for
                    a comfortable and relaxed fit, suitable for all body types.
                  </p>
                </li>
                <li>
                  <p>
                    <span className="font-bold">Ribbed Crewneck: </span>The
                    ribbed crewneck adds a touch of classic style and
                    durability, preventing stretching over time.
                  </p>
                </li>
                <li>
                  <p>
                    <span className="font-bold">Double-Stitched Seams: </span>
                    Reinforced with double-stitched seams for enhanced
                    durability, ensuring the t-shirt withstands regular wear and
                    washing.
                  </p>
                </li>
                <li>
                  <p>
                    <span className="font-bold">Eco-Friendly Production: </span>
                    Made from organic cotton grown without synthetic pesticides
                    or fertilizers, supporting sustainable farming practices.
                  </p>
                </li>
                <li>
                  <p>
                    <span className="font-bold">Breathable Fabric:</span>The
                    natural cotton material offers excellent breathability,
            ...
            <motion.div
              style={{ x: 50 }}
              animate={{ x: 0 }}
              className="h-full flex lg:flex-row-reverse lg:items-center lg:gap-3 flex-col justify-evenly"
            >
              <div className="flex flex-col justify-center h-4/6 lg:h-full lg:w-1/2">
                ...
                >
                  <p>
                    We offer a 30-day return and exchange policy. Items must be
                    in their original condition, unworn, and with all tags
                    attached.
                  </p>
                  <p>
                    To initiate a return or exchange, please contact our
                    customer service team with your order number and reason for
                    return.
                  </p>
                </AccordionItem>
                <AccordionItem
                ...
                >
                  <p>
                    We provide a detailed size guide on each product page to
                    help you find the perfect fit. You can also refer to our
                    general size chart.
                  </p>
                  <p>
                    If you have any specific questions, our customer service
                ...
                >
                  <p>
                    ...
                    shipping typically takes 5-7 business days, while express
                    shipping takes 2-3 business days.{" "}
                  </p>
                  <p>
                    Shipping times may vary based on your location and the
                ...
                >
                  ...
                  <p>
                    You can use this tracking number to monitor the status of
                ...
                >
                  <p>
                    ...
                    placement. Please contact our customer service team as soon
                    as possible with your order number and request.
                  </p>
            ...
            <motion.div style={{ x: -50 }} animate={{ x: 0 }}>
              <div className="flex justify-end gap-3 items-center">
                <div className="mr-auto">
                  <h4 className="inline font-bold text-lg mr-1">All Reviews</h4>
